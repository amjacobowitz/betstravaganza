...
const PLAYERS: { name: string; teamName: string; phone: string; password: string; isAdmin?: boolean }[] = [
  { name: 'Aaron',  teamName: 'American Robins',      phone: '2488088695', password: '8695Betz', isAdmin: true  },
  { name: 'PJ',     teamName: "Kirtland's Warblers",  phone: '2489613672', password: '3672Betz', isAdmin: true  },
  { name: 'Marco',  teamName: 'Sandhill Cranes',       phone: '2484967696', password: '7696Betz', isAdmin: true  },
  { name: 'Jeremy', teamName: 'Tufted Titmice',        phone: '2484640812', password: '0812Betz', isAdmin: true  },
  { name: 'Nick',   teamName: 'Northern Cardinals',    phone: '2482254493', password: '4493Betz'               },
  { name: 'David',  teamName: 'Red-tailed Hawks',      phone: '2487667261', password: '7261Betz'               },
  { name: 'Billy',  teamName: 'Baltimore Orioles',     phone: '3042668895', password: '8895Betz'               },
  { name: 'Jeff',   teamName: 'Rock Pigeons',          phone: '2482024717', password: '4717Betz'               },
  { name: 'Chris',  teamName: 'Bald Eagles',           phone: '2489158213', password: '8213Betz'               },
  { name: 'Reid',   teamName: 'Wood Ducks',            phone: '6054153238', password: '3238Betz'               },
  { name: 'Shad',   teamName: 'Eastern Bluebirds',     phone: '6072153514', password: '3514Betz'               },
]
